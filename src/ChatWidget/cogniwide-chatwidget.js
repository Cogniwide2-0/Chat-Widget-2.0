          ...
          <div className="_full_container_wrapper">
            ...
            <div>
              <span className="text-white font-weight-bold ">
                <img className="chat-logoheader" src={this.props.headerLogo} width="50" /> 
                </span>
              {/* <small className='online-status'>Online Now</small> */}

              </div>
               <small className='bot-name-header'>{this.props.botName}</small> 
            ...
            <div className="panel-footer">
              ...
              <div id="composer"
...

                {
                  ...
                  <button className='mic-active'></button>
                }
